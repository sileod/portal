...
- automatically copy terminal text when selection finishes, with an explicit copy button and Ctrl/Cmd+C as alternatives; Ctrl-C still interrupts when there is no selection
